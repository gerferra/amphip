...
object fuelSupplyMinTSSep {
  ...
  val stochModel = (List(NA_d, NA_inv_ctr, NA_v_ctr, NA_x_ctr) ++: basicMIPWData)
    .replace(d, d default NA_d(t, NA_ptf(s,t))) 
    .replace(S, S default NA_S(H))
  ...
  lazy val uniformDemand = uniform[List[Int]](1)(10, 50)
