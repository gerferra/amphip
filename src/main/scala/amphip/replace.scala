...
object replace {
  ...
  trait Replace[A] {
    def rep[B: Manifest](in: A, previousValue: B, replacement: B): A
  }

  def apply[A, B: Manifest](in: A, target: B, replacement: B)(implicit Replace: Replace[A]): A = Replace.rep(in, target, replacement)
  ...
  implicit val ModelReplace: Replace[Model] = new Replace[Model] {
    def rep[B: Manifest](x: Model, pv: B, nv: B): Model = raux(x, pv, nv) {
      {
  ...
  implicit val StatReplace: Replace[Stat] = new Replace[Stat] {
    def rep[B: Manifest](x: Stat, pv: B, nv: B): Stat = raux(x, pv, nv) {
      {
  ...
  implicit val SetStatReplace: Replace[SetStat] = new Replace[SetStat] {
    def rep[B: Manifest](x: SetStat, pv: B, nv: B): SetStat = raux(x, pv, nv) {
      {
  ...
  implicit val ParamStatReplace: Replace[ParamStat] = new Replace[ParamStat] {
    def rep[B: Manifest](x: ParamStat, pv: B, nv: B): ParamStat = raux(x, pv, nv) {
      {
  ...
  implicit val VarStatReplace: Replace[VarStat] = new Replace[VarStat] {
    def rep[B: Manifest](x: VarStat, pv: B, nv: B): VarStat = raux(x, pv, nv) {
      {
  ...
  implicit val ConstraintStatReplace: Replace[ConstraintStat] = new Replace[ConstraintStat] {
    def rep[B: Manifest](x: ConstraintStat, pv: B, nv: B): ConstraintStat = raux(x, pv, nv) {
      {
  ...
  implicit val ObjectiveStatReplace: Replace[ObjectiveStat] = new Replace[ObjectiveStat] {
    def rep[B: Manifest](x: ObjectiveStat, pv: B, nv: B): ObjectiveStat = raux(x, pv, nv) {
      {
  ...
  implicit val SetAttReplace: Replace[SetAtt] = new Replace[SetAtt] {
    def rep[B: Manifest](x: SetAtt, pv: B, nv: B): SetAtt = raux(x, pv, nv) {
      {
  ...
  implicit val ParamAttReplace: Replace[ParamAtt] = new Replace[ParamAtt] {
    def rep[B: Manifest](x: ParamAtt, pv: B, nv: B): ParamAtt = raux(x, pv, nv) {
      {
  ...
  implicit val VarAttReplace: Replace[VarAtt] = new Replace[VarAtt] {
    def rep[B: Manifest](x: VarAtt, pv: B, nv: B): VarAtt = raux(x, pv, nv) {
      {
  ...
  implicit val ExprReplace: Replace[Expr] = new Replace[Expr] {
    def rep[B: Manifest](x: Expr, pv: B, nv: B): Expr = raux(x, pv, nv) {
      {
  ...
  implicit val SimpleExprReplace: Replace[SimpleExpr] = new Replace[SimpleExpr] {
    def rep[B: Manifest](x: SimpleExpr, pv: B, nv: B): SimpleExpr = raux(x, pv, nv) {
      {
  ...
  implicit val ParamRefReplace: Replace[ParamRef] = new Replace[ParamRef] {
    def rep[B: Manifest](x: ParamRef, pv: B, nv: B): ParamRef = raux(x, pv, nv) {
      {
  ...
  implicit val DummyIndRefReplace: Replace[DummyIndRef] = new Replace[DummyIndRef] {
    def rep[B: Manifest](x: DummyIndRef, pv: B, nv: B): DummyIndRef = raux(x, pv, nv) {
      {
  ...
  implicit val NumExprReplace: Replace[NumExpr] = new Replace[NumExpr] {
    def rep[B: Manifest](x: NumExpr, pv: B, nv: B): NumExpr = raux(x, pv, nv) {
      {
  ...
  implicit val NumFuncRefReplace: Replace[NumFuncRef] = new Replace[NumFuncRef] {
    def rep[B: Manifest](x: NumFuncRef, pv: B, nv: B): NumFuncRef = raux(x, pv, nv) {
      {
  ...
  implicit val SymExprReplace: Replace[SymExpr] = new Replace[SymExpr] {
    def rep[B: Manifest](x: SymExpr, pv: B, nv: B): SymExpr = raux(x, pv, nv) {
      {
  ...
  implicit val SymFuncRefReplace: Replace[SymFuncRef] = new Replace[SymFuncRef] {
    def rep[B: Manifest](x: SymFuncRef, pv: B, nv: B): SymFuncRef = raux(x, pv, nv) {
      {
  ...
  implicit val SetExprReplace: Replace[SetExpr] = new Replace[SetExpr] {
    def rep[B: Manifest](x: SetExpr, pv: B, nv: B): SetExpr = raux(x, pv, nv) {
      {
  ...
  implicit val IndExprReplace: Replace[IndExpr] = new Replace[IndExpr] {
    def rep[B: Manifest](x: IndExpr, pv: B, nv: B): IndExpr = raux(x, pv, nv) {
      {
  ...
  implicit val IndEntryReplace: Replace[IndEntry] = new Replace[IndEntry] {
    def rep[B: Manifest](x: IndEntry, pv: B, nv: B): IndEntry = raux(x, pv, nv) {
      {
  ...
  implicit val DummyIndDeclReplace: Replace[DummyIndDecl] = new Replace[DummyIndDecl] {
    def rep[B: Manifest](x: DummyIndDecl, pv: B, nv: B): DummyIndDecl = raux(x, pv, nv) {
      {
  ...
  implicit val LogicExprReplace: Replace[LogicExpr] = new Replace[LogicExpr] {
    def rep[B: Manifest](x: LogicExpr, pv: B, nv: B): LogicExpr = raux(x, pv, nv) {
      {
  ...
  implicit val LinExprReplace: Replace[LinExpr] = new Replace[LinExpr] {
    def rep[B: Manifest](x: LinExpr, pv: B, nv: B): LinExpr = raux(x, pv, nv) {
      {
  ...
  implicit val StringLitReplace: Replace[StringLit] = new Replace[StringLit] {
    def rep[B: Manifest](x: StringLit, pv: B, nv: B): StringLit = raux(x, pv, nv) {
      {
  ...
  implicit val BigDecimalReplace: Replace[BigDecimal] = new Replace[BigDecimal] {
    def rep[B: Manifest](x: BigDecimal, pv: B, nv: B): BigDecimal = raux(x, pv, nv)(_ => x)
  }

  implicit val StringReplace: Replace[String] = new Replace[String] {
    def rep[B: Manifest](x: String, pv: B, nv: B): String = raux(x, pv, nv)(_ => x)
  }
  
  implicit val IntReplace: Replace[Int] = new Replace[Int] {
    def rep[B: Manifest](x: Int, pv: B, nv: B): Int = raux(x, pv, nv)(_ => x)
  }
}